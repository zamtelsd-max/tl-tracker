        ...
        <div className="space-y-3">
          <div>
            ...
            <input type="text" value={staffId} onChange={e => setStaffId(e.target.value.toUpperCase())}
              ...
              className="w-full border-2 border-slate-200 rounded-xl px-4 py-3 text-base focus:outline-none focus:border-[#00843D] transition-colors font-mono tracking-widest" />
          </div>
          <div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <input type="password" inputMode="numeric" maxLength={4} value={pin}
                ...
                placeholder="• • • •"
                className="w-full border-2 border-slate-200 rounded-xl px-4 py-3 text-base text-center tracking-widest focus:outline-none focus:border-[#00843D] transition-colors" />
            </div>
            <div>
